"""
DynamicLight-MQL: w/o parmameter sharing
"""

from tensorflow.keras.layers import Input, Dense,  Lambda, Subtract, Add, MultiHeadAttention
...
class DynamicAgentMulti(NetworkAgent):
    ...
    def choose_action(self, states, list_need):
        ...
        q_values = self.q_network.predict(phase_feat2)
        q_values_s = []
