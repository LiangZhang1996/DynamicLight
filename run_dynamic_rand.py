...
def parse_args():
    ...
    parser.add_argument("-memo",       type=str,           default='benchmark_1201_3')
    parser.add_argument("-mod",        type=str,           default="DynRand")
    parser.add_argument("-gen",        type=int,            default=1)
    parser.add_argument("-multi_process", action="store_true", default=1)
    parser.add_argument("-workers",    type=int,            default=2)

    parser.add_argument("-net1", action="store_true",       default=1)
    parser.add_argument("-net2", action="store_true",       default=1)
    parser.add_argument("-net3", action="store_true",       default=1)
